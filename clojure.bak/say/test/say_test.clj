...
(deftest one-thousand-two-hundred-thirty-four-test
  (is (= "one thousand two hundred and thirty-four" (say/number 1234))))

(deftest one-million-test
  (is (= "one million" (say/number 1000000))))

(deftest one-million-two-thousand-three-hundred-forty-five-test
  (is (= "one million two thousand three hundred and forty-five" (say/number 1002345))))

(deftest one-billion-test
  (is (= "one billion" (say/number 1000000000))))

(deftest a-big-number-test
  (is (= "nine hundred and eighty-seven billion six hundred and fifty-four million three hundred and twenty-one thousand one hundred and twenty-three" (say/number 987654321123))))
